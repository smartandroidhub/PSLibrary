...
public class ActionBarView extends AbsActionBarView {
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
           ...
           /**
            * EDITED BY SHAILESH SHARMA TO CHANGE THE abs_home button image
            */
            // mExpandedHomeLayout.setIcon(mIcon.getConstantState().newDrawable(/* TODO getResources() */));
            Drawable myIcon = getResources().getDrawable(R.drawable.back_arrow_icon);
            mExpandedHomeLayout.setIcon(myIcon);
            //====================================================
